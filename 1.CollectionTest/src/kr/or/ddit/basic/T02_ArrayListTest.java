...
//		List list1 = new Vector();	//vector로 바꿔도 똑같은 리스트이기 때문에 에러가 나지 않는다.
		...
		//String[] strArr2 = (String[]) list2.toArray(); // java.lang.ClassCastException: [Ljava.lang.Object; cannot be cast to [Ljava.lang.String;
			//toArray는 기본적으로 Object만 담긴다. String으로 바꾸고 싶으면 list2.toArray(new String[0]); 를 써줘야 함.  
...
//			list2.remove(i);
//		}
		//size이기 때문에 삭제하면 인덱스가 삭제된 공간으로 밀리기 때문에 이렇게 사용 하면 안 된다.
