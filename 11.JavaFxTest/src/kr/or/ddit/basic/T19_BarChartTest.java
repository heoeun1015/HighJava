...
public class T19_BarChartTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Series<String, Number> ser1 = new XYChart.Series<String, Number>();
		...
		Series<String, Number> ser2 = new XYChart.Series<String, Number>();
		...
		Series<String, Number> ser3 = new XYChart.Series<>();
		ser3.setName("2017년");
